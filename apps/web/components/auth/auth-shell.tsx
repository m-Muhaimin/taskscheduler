  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[minmax(0,1fr)_minmax(0,0.85fr)]">
      <div className="bg-surface flex flex-col px-6 md:px-12 py-6">
        ...
        <main className="flex-1 flex flex-col justify-center w-full max-w-[400px] mx-auto py-12">
          <h1 className="font-head font-semibold text-[32px] leading-[1.1] tracking-[-0.02em]">{title}</h1>

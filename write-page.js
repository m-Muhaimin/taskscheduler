        ...
        <div className="container mx-auto max-w-3xl space-y-12">
          ...
          <div className="divide-y divide-border">
            <FAQItem 
              ...
              answer="No. Everything happens via standard SMS. Your customers just text and reply—no accounts or app store visits required." 
            />
            <FAQItem 
              question="Does it actually work with Google Calendar?
